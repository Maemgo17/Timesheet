...
if (empty($usuarios)) {
    echo "<script>alert('No hay usuarios disponibles para modificar.'); window.location.href='settings.php';</script>";
    exit;
}
?>
    ...
    <style>
        * {
        ...
        select {
            ...
            margin-bottom: 30px; /* Espaciado entre los campos */
        ...
        button {
            ...
            width: 80%; /* Ajustado para ser más estrecho */
            margin: -10px auto; /* Espaciado y centrado automático */
        }

...
if (isset($_POST['register'])) {
    ...
    if ($contrasena !== $confirmarContrasena) {
        ...
        if ($usuarioExistente) {
            ...
            // Insertar el nuevo usuario con rol 'usuario' y DNI
...
<head>
    ...
    <style>
        * {
        ...
        input:focus {
            border: 1px solid #4CAF50; /* Color verde al enfocar */
...
<body>
    <div class="container">
        ...
        <form action="" method="POST">
            ...
            <input type="text" name="dni" placeholder="DNI" required> <!-- Nuevo campo para DNI -->
